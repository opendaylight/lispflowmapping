...
1.  Install and run the OpenDaylight distribution on the controller VM.
    ...
    <https://docs.opendaylight.org/en/stable-fluorine/getting-started-guide/installing_opendaylight.html>`__
...
6.  Now, install and run OpenDaylight on the VM. Please follow the general
    ...
    <https://docs.opendaylight.org/en/stable-fluorine/getting-started-guide/installing_opendaylight.html>`__ for this step.
