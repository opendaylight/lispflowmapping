...
class MultiSiteScenario {
    ...
    void pingSimulation(final Site srcSite, final int srcHostIndex, final Site dstSite, final int dstHostIndex) {
        pingSimulation(srcSite, srcHostIndex, dstSite, dstHostIndex, true);
    }

    void pingSimulation(final Site srcSite, final int srcHostIndex, final Site dstSite, final int dstHostIndex, final
    boolean vniEqualityValue) {
        final InstanceIdType instanceIdTypeDst = oneWayReachability(srcSite, srcHostIndex, dstSite, dstHostIndex);
    ...
    void oneWayReachability(final Site srcSite, final int srcHostIndex, final Site dstSite, final int dstHostIndex, final
