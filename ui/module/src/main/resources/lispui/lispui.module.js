define(['angularAMD',
  ...
  var lispui = angular.module('app.lispui', ['ui.router.state', 'app.core', 'app.common.yangUtils', 'restangular']);

  lispui.config(function($stateProvider, $controllerProvider, $compileProvider, $provide, $translateProvider, NavHelperProvider) {
    ...
    $stateProvider.state('main.lispui.keys-edit', {
      url:'/keys-edit/{eid}',
      views: {
        'lispui': {
          templateUrl: '/src/app/lispui/keys/key.edit.tpl.html',
          controller: 'KeysEditLispuiCtrl'
        }
      }
    });
