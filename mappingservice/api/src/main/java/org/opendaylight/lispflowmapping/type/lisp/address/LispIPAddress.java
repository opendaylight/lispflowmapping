...
public abstract class LispIPAddress extends LispAddress{
	...
	public LispIPAddress(int address, AddressFamilyNumberEnum afi) {
        super(afi);
        try {
	...
	public LispIPAddress(byte[] address, AddressFamilyNumberEnum afi) {
        super(afi);
        try {
	...
	public LispIPAddress(String name, AddressFamilyNumberEnum afi) {
        super(afi);
        try {
