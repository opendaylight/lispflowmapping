...
public interface IMappingSystem {
     ...
     */
    void addMapping(MappingOrigin origin, Eid key, ExtendedMappingRecord mapping, boolean merge);
     ...
     */
    ExtendedMappingRecord getMapping(Eid src, Eid dst);
     ...
     */
    ExtendedMappingRecord getMapping(Eid dst);
     ...
     */
    ExtendedMappingRecord getMapping(Eid src, Eid dst, XtrId xtrId);
     ...
     */
    ExtendedMappingRecord getMapping(MappingOrigin origin, Eid key);
