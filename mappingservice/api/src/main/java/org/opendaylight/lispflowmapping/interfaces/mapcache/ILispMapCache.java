...
public interface ILispMapCache extends IMapCache {
     ...
     */
    void addMapping(Eid key, ExtendedMappingRecord mapping, Set<IpAddressBinary> sourceRlocs);
     ...
     *            Mapping to be stored
     */
    void addMapping(Eid key, XtrId xtrId, ExtendedMappingRecord mapping);
     ...
     */
    ExtendedMappingRecord getMapping(Eid key, XtrId xtrId);
