...
public interface ILispSouthboundPlugin extends RpcService {
     ...
     * @return
     */
    Future<RpcResult<java.lang.Void>> handleMapNotify(MapNotify mapNotify, TransportAddress targetAddress);
     ...
     * @return
     */
    Future<RpcResult<java.lang.Void>> handleMapReply(MapReply mapReply, TransportAddress targetAddress);
