...
public class MaskUtils {
    ...
    public static boolean isMaskable(Address address, int mask) {
    ...
    public static InetAddress normalizeIP(InetAddress address, int mask) throws UnknownHostException {
