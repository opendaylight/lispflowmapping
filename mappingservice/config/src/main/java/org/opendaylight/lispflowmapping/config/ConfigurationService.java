...
public class ConfigurationService implements ManagedService {
    ...
    public static volatile boolean CONFIG_EVENT_OCCURED = true;
    public static final Object NOTIFIER_OBJECT = new Object();

    HashMap<String, Consumer> configMethods;

    public ConfigurationService() {
        CONFIG_EVENT_OCCURED = false;
    ...
    public void updated(Dictionary dictionary) throws ConfigurationException {
        ...
        synchronized (NOTIFIER_OBJECT) {
            CONFIG_EVENT_OCCURED = true;
            NOTIFIER_OBJECT.notifyAll();
        }
    }
