...
public final class ConfigIni {
     ...
     * `etc/custom.properties file`, hosted in the odlparent repository [0]. The User Guide [1] has to be updated too,
     * including when a configuration option's semantics or behavior is changed.
     *
