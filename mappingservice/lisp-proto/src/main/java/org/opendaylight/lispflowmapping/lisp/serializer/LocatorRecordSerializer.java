...
public class LocatorRecordSerializer {
    ...
    protected LocatorRecord deserialize(ByteBuffer buffer) {
        ...
        LispAddressSerializerContext ctx =
                new LispAddressSerializerContext(LispAddressSerializerContext.AddressContext.RLOC);
        Rloc rloc = (Rloc) LispAddressSerializer.getInstance().deserialize(buffer, ctx);
