...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.lisp.address.types.rev151105.ListItemId;
...
public class ExplicitLocatorPathSerializer extends LcafSerializer {
    ...
    protected LispAddress deserializeLcafData(ByteBuffer buffer, byte res2, short length, LispAddressSerializerContext ctx) {
        ...
        while (length > 0) {
            ...
            builder.setHopId(new ListItemId("Hop " + (hops.size()+1)));
        ...
        lab.setAddressType(ExplicitLocatorPathLcaf.class);
        lab.setVirtualNetworkId(ctx.getVni());
        lab.setAddress(new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.lisp.address.types.rev151105.lisp.address.address.ExplicitLocatorPathBuilder()
