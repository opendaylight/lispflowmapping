...
import org.opendaylight.lispflowmapping.lisp.serializer.cache.MapRegisterCacheValueBuilder;
...
public final class MapRegisterSerializer {
    ...
    private static final int NUM_FO_BYTES_FROM_START_TO_AUTH_DATA_LENGTH_POS = 14;
    ...
    private byte[] extractEidPrefix(final ByteBuffer buffer, int authDataLength) {
        final int startPositionOfEidPrefixAFI = NUM_FO_BYTES_FROM_START_TO_AUTH_DATA_LENGTH_POS
        ...
        Optional<Integer> eidPrefixLengthOpt = resolveEidPrefixAfi(eidPrefixAfi);
    ...
    private Optional<Integer> resolveEidPrefixAfi(final int eidPrefixAfi) {
        switch (eidPrefixAfi) {
            case IPV4:
