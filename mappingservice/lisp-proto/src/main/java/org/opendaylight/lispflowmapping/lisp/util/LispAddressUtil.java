...
public final class LispAddressUtil {
    ...
    public static Eid asIpPrefixBinaryEid(Eid eid) {
        ...
        if (address instanceof Ipv4Binary) {
            ...
            return eid;
        } else if (address instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.lisp.address.types.rev151105.lisp.address.address.Ipv4) {
            return LispAddressUtil.asIpv4PrefixBinaryEid(((Ipv4) address).getIpv4().getValue() + "/32",
                    eid.getVirtualNetworkId());
        } else if (address instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.lisp.address.types.rev151105.lisp.address.address.Ipv6) {
