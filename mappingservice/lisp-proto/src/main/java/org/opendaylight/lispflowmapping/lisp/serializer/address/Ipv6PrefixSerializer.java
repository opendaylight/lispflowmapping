...
public class Ipv6PrefixSerializer extends LispAddressSerializer {
    ...
    protected void serializeData(ByteBuffer buffer, LispAddress lispAddress) {
        ...
        buffer.put((InetAddresses.forString(address.getIpv6Prefix().getValue())).getAddress());
    }
    ...
    protected LispAddress deserializeData(ByteBuffer buffer, LispAddressSerializerContext ctx) {
        ...
        lab.setAddress(new Ipv6PrefixBuilder().setIpv6Prefix
                (new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.inet.types.rev100924.Ipv6Prefix(
