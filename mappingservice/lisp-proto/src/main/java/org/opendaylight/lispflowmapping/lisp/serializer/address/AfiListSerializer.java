...
public class AfiListSerializer extends LcafSerializer {
    ...
    @Override
    public LispAddress deserializeLcafData(ByteBuffer buffer, byte res2, short length, LispAddressSerializerContext ctx) {
        ...
        lab.setAddressType(AfiListLcaf.class);
        lab.setVirtualNetworkId(ctx.getVni());
        lab.setAddress(new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.lisp.address.types.rev151105.lisp.address.address.AfiListBuilder()
