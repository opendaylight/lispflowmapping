...
public class MapRequestSerializationTest extends BaseTestCase {
    ...
    public void serialize__SingleEidItem() throws Exception {
        MapRequestBuilder mrBuilder = new MapRequestBuilder();
        mrBuilder.setEidItem(new ArrayList<EidItem>());
        mrBuilder.getEidItem().add(new EidItemBuilder().setEid(LispAFIConvertor.asIpv4PrefixEid("1.2.3.4/32")).build());
    ...
    public void serialize__MultipleEidItem() throws Exception {
        ...
        mrBuilder.setEidItem(new ArrayList<EidItem>());
        mrBuilder.getEidItem().add(new EidItemBuilder().setEid(LispAFIConvertor.asIpv4PrefixEid("1.2.3.4/32")).build());
        mrBuilder.getEidItem().add(new EidItemBuilder().setEid(LispAFIConvertor.asIpv4PrefixEid("4.3.2.1/0")).build());
    ...
    public void serialize__SingleItrRloc() throws Exception {
        ...
        mrBuilder.getItrRloc().add(new ItrRlocBuilder().setRloc(LispAFIConvertor.asIpv4Rloc("1.2.3.4")).build());
        ByteBuffer expected = hexToByteBuffer("10 00 00 00 00 00 " //
    ...
    public void serialize__MultipleItrRloc() throws Exception {
        ...
        mrBuilder.setItrRloc(new ArrayList<ItrRloc>());
        mrBuilder.getItrRloc().add(new ItrRlocBuilder().setRloc(LispAFIConvertor.asIpv4Rloc("1.2.3.4")).build());
        mrBuilder.getItrRloc().add(new ItrRlocBuilder().setRloc(LispAFIConvertor.asIpv4Rloc("4.3.2.1")).build());
    ...
    public void serialize__All() throws Exception {
        ...
        mrBuilder.setSourceEid(new SourceEidBuilder().setEid(LispAFIConvertor.asIpv4Eid(("10.0.0.1"))).build());
        mrBuilder.setItrRloc(new ArrayList<ItrRloc>());
        mrBuilder.getItrRloc().add(new ItrRlocBuilder().setRloc(LispAFIConvertor.asIpv4Rloc("1.2.3.4")).build());
        mrBuilder.getItrRloc().add(new ItrRlocBuilder().setRloc(LispAFIConvertor.asIpv6Rloc("1:2:3:4:5:6:7:8")).build());
        mrBuilder.setEidItem(new ArrayList<EidItem>());
        mrBuilder.getEidItem().add(new EidItemBuilder().setEid(LispAFIConvertor.asIpv4PrefixEid("1.2.3.4/32")).build());
    ...
    public void serialize__AllWithMapReply() throws Exception {
        ...
        mapRequestBuilder.setSourceEid(new SourceEidBuilder().setEid(LispAFIConvertor.asIpv4Eid(("10.0.0.1"))).build());
        mapRequestBuilder.setItrRloc(new ArrayList<ItrRloc>());
        mapRequestBuilder.getItrRloc().add(new ItrRlocBuilder().setRloc(LispAFIConvertor.asIpv4Rloc("1.2.3.4")).build());
        mapRequestBuilder.getItrRloc().add(new ItrRlocBuilder().setRloc(LispAFIConvertor.asIpv6Rloc("1:2:3:4:5:6:7:8")).build());
        mapRequestBuilder.setEidItem(new ArrayList<EidItem>());
        mapRequestBuilder.getEidItem().add(new EidItemBuilder().setEid(LispAFIConvertor.asIpv4PrefixEid("1.2.3.4/32")).build());
        ...
        locatorBuilder.setRloc(LispAFIConvertor.asIpv4Rloc("0.0.0.2"));
