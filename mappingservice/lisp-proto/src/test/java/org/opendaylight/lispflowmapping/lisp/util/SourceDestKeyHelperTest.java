...
public class SourceDestKeyHelperTest {
    ...
    private static final InstanceIdType INSTANCE_ID = new InstanceIdType(Uint32.valueOf(100L));
    ...
    private static Ipv4PrefixBinary getIpv4PrefixBinary(Ipv4AddressBinary ipv4AddressBinary, short mask) {
        return new Ipv4PrefixBinaryBuilder().setIpv4AddressBinary(ipv4AddressBinary)
                .setIpv4MaskLength(Uint8.valueOf(mask)).build();
    }
}
