...
public class MapRegisterSerializationTest extends BaseTestCase {
    ...
    public void serialize__NoAuthenticationData() throws Exception {
        ...
        mrBuilder.getMappingRecordItem().add(new MappingRecordItemBuilder().setMappingRecord(
                new MappingRecordBuilder().setRecordTtl(55)
                        .setEid(LispAFIConvertor.asIpv4PrefixEid("0.0.0.1/32")).build()).build());
    ...
    public void deserialize__MultipleRecords() throws Exception {
        ...
        assertEquals(LispAFIConvertor.asIpv4PrefixEid("153.16.254.1/32"), mr.getMappingRecordItem().get(0)
                .getMappingRecord().getEid());
        assertEquals(LispAFIConvertor.asIpv4PrefixEid("151.16.254.1/32"), mr.getMappingRecordItem().get(2)
                .getMappingRecord().getEid());
        assertEquals(LispAFIConvertor.asIpv4Rloc("192.168.136.11"), mr.getMappingRecordItem().get(1)
                .getMappingRecord().getLocatorRecord().get(0).getRloc());
        assertEquals(LispAFIConvertor.asIpv4Rloc("192.168.136.13"), mr.getMappingRecordItem().get(3)
                .getMappingRecord().getLocatorRecord().get(0).getRloc());
    }
