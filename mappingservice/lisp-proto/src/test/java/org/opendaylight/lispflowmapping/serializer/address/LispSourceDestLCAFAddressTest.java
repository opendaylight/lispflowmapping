...
public class LispSourceDestLCAFAddressTest extends BaseTestCase {
    ...
    public void deserialize__Simple() throws Exception {
        ...
        assertEquals(LispAFIConvertor.asPrimitiveIPv4AfiPrefix("17.34.51.68", 0x10), srcDestAddress.getSrcAddress().getPrimitiveAddress());
        assertEquals(LispAFIConvertor.asPrimitiveIPv4AfiPrefix("34.51.68.85", 0x18), srcDestAddress.getDstAddress().getPrimitiveAddress());
