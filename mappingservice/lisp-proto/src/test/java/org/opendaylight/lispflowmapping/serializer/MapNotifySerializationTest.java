...
public class MapNotifySerializationTest extends BaseTestCase {
    ...
    public void deserialize__MultipleRecords() throws Exception {
        ...
        assertEquals(LispAFIConvertor.asIpv4Prefix("153.16.254.1/32"), mn.getMappingRecordItem().get(0)
                .getMappingRecord().getEid());
        assertEquals(LispAFIConvertor.asIpv4Prefix("151.16.254.1/32"), mn.getMappingRecordItem().get(2)
                .getMappingRecord().getEid());
        assertEquals(LispAFIConvertor.asIpv4("192.168.136.11"), mn.getMappingRecordItem().get(1)
                .getMappingRecord().getLocatorRecord().get(0).getRloc());
        assertEquals(LispAFIConvertor.asIpv4("192.168.136.13"), mn.getMappingRecordItem().get(3)
                .getMappingRecord().getLocatorRecord().get(0).getRloc());
    }
    ...
    public void deserialize__Locators() throws Exception {
        ...
        assertEquals(LispAFIConvertor.asIpv4("192.168.136.10"), loc0.getRloc());
        assertEquals(LispAFIConvertor.asIpv4("204.170.170.17"), loc1.getRloc());
    }
