...
public class MapNotifySerializationTest extends BaseTestCase {
    ...
    public void serialize__Fields() throws Exception {
        ...
        mnBuilder.getMappingRecordItem().add(
                new MappingRecordItemBuilder().setMappingRecord(
                        new MappingRecordBuilder().setEid(LispAFIConvertor.asIpv4PrefixEid("0.0.0.1/32")).build())
                        .build());
        mnBuilder.getMappingRecordItem().add(
                new MappingRecordItemBuilder().setMappingRecord(
                        new MappingRecordBuilder().setEid(LispAFIConvertor.asIpv4PrefixEid("0.0.0.73/32")).build())
                        .build());
    ...
    public void serialize__NoAuthenticationData() throws Exception {
        ...
        mnBuilder.getMappingRecordItem().add(
                new MappingRecordItemBuilder().setMappingRecord(
                        new MappingRecordBuilder().setEid(LispAFIConvertor.asIpv4PrefixEid("0.0.0.1/32"))
...
*/
    ...
    public void deserialize__MultipleRecords() throws Exception {
        ...
        assertEquals(LispAFIConvertor.asIpv4PrefixEid("153.16.254.1/32"), mn.getMappingRecordItem().get(0)
                .getMappingRecord().getEid());
        assertEquals(LispAFIConvertor.asIpv4PrefixEid("151.16.254.1/32"), mn.getMappingRecordItem().get(2)
                .getMappingRecord().getEid());
        assertEquals(LispAFIConvertor.asIpv4Rloc("192.168.136.11"), mn.getMappingRecordItem().get(1)
                .getMappingRecord().getLocatorRecord().get(0).getRloc());
        assertEquals(LispAFIConvertor.asIpv4Rloc("192.168.136.13"), mn.getMappingRecordItem().get(3)
                .getMappingRecord().getLocatorRecord().get(0).getRloc());
    }
    ...
    public void deserialize__Locators() throws Exception {
        ...
        assertEquals(LispAFIConvertor.asIpv4Rloc("192.168.136.10"), loc0.getRloc());
        assertEquals(LispAFIConvertor.asIpv4Rloc("204.170.170.17"), loc1.getRloc());
    }
