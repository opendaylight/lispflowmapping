...
public class LispAddressUtilTest {
     ...
     * - {@link LispAddressUtil#toEid(Ipv6Prefix, InstanceIdType)}
     * - {@link LispAddressUtil#toEid(MacAddress, InstanceIdType)}
     * methods with various input.
     */
    @Test
    public void toEid() {
        final Eid eidFromDistinguishedName = LispAddressUtil.toEid(DISTINGUISHED_NAME_TYPE_TEST, INSTANCE_ID_TYPE_TEST);
        ...
        assertEquals(Ipv4PrefixAfi.class, eidFromIpPrefix.getAddressType());
        assertEquals(INSTANCE_ID_TYPE_TEST, eidFromIpPrefix.getVirtualNetworkId());
        assertEquals(IPV4_ADDRESS_PREFIX_VALUE_TEST, ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
                .lisp.address.types.rev151105.lisp.address.address.Ipv4Prefix)eidFromIpPrefix.getAddress())
                .getIpv4Prefix().getValue());

        final Eid eidFromIpv4 = LispAddressUtil.toEid(IPV4_ADDRESS_TEST, INSTANCE_ID_TYPE_TEST);
        ...
        final Eid eidFromIpv4Prefix = LispAddressUtil.toEid(IPV4_ADDRESS_PREFIX_TEST, INSTANCE_ID_TYPE_TEST);
        ...
        final Eid eidFromIpv6 = LispAddressUtil.toEid(IPV6_ADDRESS_TEST, INSTANCE_ID_TYPE_TEST);
        ...
        final Eid eidFromIpv6Prefix = LispAddressUtil.toEid(IPV6_ADDRESS_PREFIX_TEST, INSTANCE_ID_TYPE_TEST);
        ...
        final Eid eidFromMac = LispAddressUtil.toEid(MAC_ADDRESS_TEST, INSTANCE_ID_TYPE_TEST);
