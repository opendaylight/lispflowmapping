...
public class MapReplySerializationTest extends BaseTestCase {
    ...
    public void serialize__MultipleRecordsWithoutRLOCs() throws Exception {
        ...
        MappingRecordBuilder recordBuilder = new MappingRecordBuilder();
        recordBuilder.setEid(LispAFIConvertor.asIpv6PrefixEid("0:0:0:0:0:0:0:8/128"));
        mrBuilder.getMappingRecordItem().add(
                new MappingRecordItemBuilder().setMappingRecord(recordBuilder.build()).build());

        recordBuilder.setEid(LispAFIConvertor.asIpv4PrefixEid("8.2.4.5/32"));
        mrBuilder.getMappingRecordItem().add(
                new MappingRecordItemBuilder().setMappingRecord(recordBuilder.build()).build());
    ...
    public void serialize__EidRecordFields() throws Exception {
        ...
        eidToLocator1.setEid(LispAFIConvertor.asIpv4PrefixEid("0.0.0.1/32"));
        ...
        eidToLocator2.setEid(LispAFIConvertor.asIpv4PrefixEid("0.0.0.7/32"));
    ...
    public void serialize__LocatorRecordFields() throws Exception {
        ...
        eidToLocatorBuilder.setEid(LispAFIConvertor.asIpv4PrefixEid("0.0.0.1/32"));
        ...
        locatorBuilder1.setRloc(LispAFIConvertor.asIpv4Rloc("0.0.0.1"));
        ...
        locatorBuilder2.setRloc(LispAFIConvertor.asIpv4Rloc("0.0.0.2"));
