...
public class NorthboundService implements INorthboundService, CommandProvider{
     ...
     *
     * @param containerName
     *            name of the container context in which the mapping needs to be added
     * @param mapRegisterNB
     ...
     *
     * @param containerName
     *            name of the container context from which the mapping is going to be retrieved
     * @param iid
     ...
     *
     * @param containerName
     *            name of the container context in which the key needs to be setted
     * @param authKeyNB
    ...
    public String addAuthKey(@PathParam("containerName") String containerName, @TypeHint(AuthKeyNB.class) AuthKeyNB authKeyNB) {
    	...
    	boolean success = 
    			nbService.getMappingService().addAuthenticationKey(lispAddress, authKeyNB.getMaskLength(), authKeyNB.getKey());
     ...
     *
     * @param containerName
     *            name of the container context from which the key is going to be retrieved
     *            
     * @param afi
     *            Address Family of the address (IPv4, IPv6 or MAC)
     *            
     ...
     *
     * @param containerName
     *            name of the container context from which the key is going to be deleted
     *            
     * @param afi
     *            Address Family of the address (IPv4, IPv6 or MAC)
     *            
    ...
    public String delAuthKey(@PathParam("containerName") String containerName, 
    		@PathParam("afi") int afi, @PathParam("address") String address, @PathParam("mask") int mask) {
