...
public class RadixTrie<T> {
    ...
    /**
     * For a given prefix look up the longest prefix match, and then return the set of its children (excluding the
     * longest prefix match itself, but also virtual nodes).
     *
     * @param prefix Big endian byte array representation of the prefix to be looked up.
     * @param preflen Prefix length
