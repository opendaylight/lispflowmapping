...
public class LispSouthboundPluginTest {
    ...
    public void setLispAddressTest_withEqualAddress() throws NoSuchFieldException, IllegalAccessException {
        lispSouthboundPlugin.setLispAddress("1.1.1.1");
    ...
    public void setLispAddressTest_withChangedAddress() throws NoSuchFieldException, IllegalAccessException {
        lispSouthboundPlugin.setLispAddress(ADDRESS);
     ...
     */
    // TODO remove expectation when fixed
    @Test(expected = NullPointerException.class)
    @SuppressWarnings("unchecked")
    public void closeTest() throws Exception {
        lispSouthboundPlugin.setLispAddress("1.1.1.1");

        EventLoopGroup elpMock = Mockito.mock(EventLoopGroup.class);
        LispSouthboundPluginTest.setField("eventLoopGroup", elpMock);
        ...
        LispSouthboundPluginTest.setField("sbRpcRegistration", registrationMock);

        LispSouthboundHandler handlerMock = Mockito.mock(LispSouthboundHandler.class);
        LispSouthboundPluginTest.setField("lispSouthboundHandler", handlerMock);

        lispSouthboundPlugin.close();

        Mockito.verify(channel, Mockito.times(2)).close();
        Mockito.verify(elpMock).shutdownGracefully();
    ...
    private static <T> void setField(String fieldName, T obj) throws NoSuchFieldException, IllegalAccessException {
