...
public class LispSouthboundPlugin implements IConfigLispSouthboundPlugin, AutoCloseable {
    ...
    public void init() {
        ...
        synchronized (startLock) {
            lispSouthboundHandler = new LispSouthboundHandler(this, new MapRegisterCache(), dataBroker);
            lispSouthboundHandler.setSimpleMapCache(new SimpleMapCache(new HashMapDb()));
