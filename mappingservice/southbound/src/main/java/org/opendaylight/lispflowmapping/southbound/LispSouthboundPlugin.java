...
@Component(immediate = true, property = "type=default", configurationPid = "org.opendaylight.lispflowmapping",
    service = {IConfigLispSouthboundPlugin.class, LispSouthboundPlugin.class}, reference = {
        @Reference(service = DataBroker.class, name = "dataBroker"),
        @Reference(service = NotificationPublishService.class, name = "notificationPublishService"),
        @Reference(service = ClusterSingletonServiceProvider.class, name = "clusterSingletonService")})
