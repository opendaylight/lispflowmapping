 ...
 */
@Singleton
@Component(service = { }, property = "type=default")
public class LispSouthboundRPC {
    ...
    @VisibleForTesting
    ListenableFuture<RpcResult<SendMapNotifyOutput>> sendMapNotify(final SendMapNotifyInput mapNotifyInput) {
    ...
    @VisibleForTesting
    ListenableFuture<RpcResult<SendMapReplyOutput>> sendMapReply(final SendMapReplyInput mapReplyInput) {
    ...
    @VisibleForTesting
    ListenableFuture<RpcResult<SendMapRequestOutput>> sendMapRequest(final SendMapRequestInput mapRequestInput) {
    ...
    @VisibleForTesting
    ListenableFuture<RpcResult<SendMapRegisterOutput>> sendMapRegister(final SendMapRegisterInput mapRegisterInput) {
