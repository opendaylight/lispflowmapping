...
public class LispSouthboundRPC implements OdlLispSbService {
    ...
    @Inject
    @Activate
    public LispSouthboundRPC(final @Reference IConfigLispSouthboundPlugin lispSbPlugin,
        final @Reference RpcProviderService rpcProviderService) {
        Preconditions.checkArgument(lispSbPlugin instanceof LispSouthboundPlugin);
        this.lispSbPlugin = (LispSouthboundPlugin) lispSbPlugin;
