...
import org.opendaylight.yang.gen.v1.lispflowmapping.rev131031.GotMapNotifyBuilder;
import org.opendaylight.yang.gen.v1.lispflowmapping.rev131031.GotMapReplyBuilder;
    ...
    private void handleMapNotify(ByteBuffer inBuffer, InetAddress sourceAddress, int port) {
        try {
            ...
            if (notificationProvider != null) {
                ...
                logger.trace("MapNotify was published!");
            } else {
                logger.warn("Notification Provider is null!");
            }
        } catch (RuntimeException re) {
