...
public class LispSouthboundService implements ILispSouthboundService {
    ...
    public void handlePacket(DatagramPacket packet) {
        ...
        handleStats(type);
        Object lispType = LispType.forValue(type);
        if (lispType == LispType.EncapsulatedControlMessage) {
