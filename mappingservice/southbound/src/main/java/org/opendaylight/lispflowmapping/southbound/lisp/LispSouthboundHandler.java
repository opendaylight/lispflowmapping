...
import org.opendaylight.yang.gen.v1.urn.opendaylight.lfm.lisp.proto.rev151105.map.register.cache.metadata.grouping.EidLispAddress;
import org.opendaylight.yang.gen.v1.urn.opendaylight.lfm.lisp.proto.rev151105.map.register.cache.metadata.grouping.EidLispAddressBuilder;
    ...
    private void handleMapRegister(ByteBuffer inBuffer, InetAddress sourceAddress, int port) {
        try {
            ...
            if (isMapRegisterMsgCurrent(cacheValue)) {
                ...
                if (entry != null) {
                    final MapRegisterCacheValue originCacheValue = entry.getValue();

                    final MapRegisterCacheMetadataBuilder cacheMetadataBldNew = new MapRegisterCacheMetadataBuilder
                            (originCacheValue.getMapRegisterCacheMetadata());
                    ...
                    cacheValueBldNew.setPacketData(originCacheValue.getPacketData());
