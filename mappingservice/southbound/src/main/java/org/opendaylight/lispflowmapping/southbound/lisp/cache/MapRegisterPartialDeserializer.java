...
public final class MapRegisterPartialDeserializer {
    ...
    private static MapRegisterCacheValue createValueFromBytes(ByteBuffer buffer, final int authDataLength, boolean
        ...
        final MapRegisterCacheMetadataBuilder mapRegisterCacheMetadataBuilder = new MapRegisterCacheMetadataBuilder();
        mapRegisterCacheMetadataBuilder.setMergeEnabled(shouldMerge);
        mapRegisterCacheMetadataBuilder.setWantMapNotify(ByteUtil.extractBit(thirdByte, WANT_MAP_NOTIFY));
        ...
        mapRegisterCacheValueBuilder.setPacketData(newPayload);
