...
public final class MapRegisterPartialDeserializer {
     ...
     * @return
     */
    private static MapRegisterCacheValue createValueFromBytes(ByteBuffer buffer, final int authDataLength, boolean shouldMerge) {
    ...
    private static Optional<Integer> resolveEidPrefixAfi(final int eidPrefixAfi) {
        switch (eidPrefixAfi) {
            case IPV4:
