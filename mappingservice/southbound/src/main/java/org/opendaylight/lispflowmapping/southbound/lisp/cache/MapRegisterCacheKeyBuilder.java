...
public class MapRegisterCacheKeyBuilder implements Builder <MapRegisterCacheKey> {
    ...
    public byte[] getInstanceID() {
        return _instanceId == null ? null : _instanceId.clone();
    }
    ...
    public MapRegisterCacheKeyBuilder setInstanceId(final byte[] value) {
    ...
    private static final class MapRegisterCacheKeyImpl implements MapRegisterCacheKey {
        ...
        private final byte[] _instanceId;
        ...
        public int hashCode() {
            ...
            result = prime * result + Arrays.hashCode(_instanceId);
            return result;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!Arrays.equals(_instanceId, other.getInstanceId())) {
                return false;
            }
            return true;
        }
        ...
        public String toString() {
            ...
            if (_instanceId != null) {
                ...
                builder.append(Arrays.toString(_instanceId));
             }
