...
public class EidToLocatorRecordSerializer {
	...
	public EidToLocatorRecord deserialize(ByteBuffer buffer) {
        ...
        eidToLocatorRecord.setPrefix(LispAddressSerializer.valueOf(buffer));
    ...
    public void serialize(ByteBuffer replyBuffer, EidToLocatorRecord record) {
        ...
        LispAddressSerializerFactory.getSerializer(record.getPrefix()).serialize(replyBuffer, record.getPrefix());
    ...
    public int getSerializationSize(EidToLocatorRecord record) {
        int size = Length.HEADER_SIZE + LispAddressSerializerFactory.getSerializer(record.getPrefix()).getAddressSize(record.getPrefix());
        for (LocatorRecord locatorRecord : record.getLocators()) {
