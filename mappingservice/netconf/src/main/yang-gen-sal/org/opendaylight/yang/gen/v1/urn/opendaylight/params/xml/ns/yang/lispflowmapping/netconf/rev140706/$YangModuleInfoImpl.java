...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "lfm-netconf-connector";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:lispflowmapping:netconf";
    private final String revision = "2014-07-06";
    private final String resourcePath = "/META-INF/yang/lfm-netconf-connector.yang";
