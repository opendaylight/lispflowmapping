...
public class DelegatingDataTreeListenerTest {
    ...
    private final DelegatingDataTreeListener<Network> delegatingDataTreeListener_network =
    ...
    public void onDataTreeChangedTest_write() {
        ...
        Mockito.when(DATA_OBJECT_MODIFICATION.getModificationType()).thenReturn(DataObjectModification.ModificationType.WRITE);

        delegatingDataTreeListener_network.onDataTreeChanged(Lists.newArrayList(DATA_TREE_MODIFICATION));
    ...
    public void onDataTreeChangedTest_delete() {
        ...
        Mockito.when(DATA_OBJECT_MODIFICATION.getModificationType()).thenReturn(DataObjectModification.ModificationType.DELETE);
    ...
    public void onDataTreeChangedTest_subtreeModified() {
        Mockito.when(DATA_TREE_MODIFICATION.getRootNode()).thenReturn(DATA_OBJECT_MODIFICATION);
        Mockito.when(DATA_OBJECT_MODIFICATION.getDataAfter()).thenReturn(DUMMY_NETWORK);
        Mockito.when(DATA_OBJECT_MODIFICATION.getModificationType()).thenReturn(DataObjectModification.ModificationType.SUBTREE_MODIFIED);
