...
public class LispNeutronPortHandler extends LispNeutronService implements
        ClusteredDataTreeChangeListener<Port> {
    ...
    public void neutronPortUpdated(Port port) {
