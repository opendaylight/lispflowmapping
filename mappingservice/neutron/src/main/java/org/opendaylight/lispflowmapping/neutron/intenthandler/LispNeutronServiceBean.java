 ...
 */
public class LispNeutronServiceBean implements AutoCloseable, BindingAwareProvider {
    private static final Logger LOG = LoggerFactory.getLogger(LispNeutronServiceBean.class);
    ...
    public LispNeutronServiceBean(final DataBroker dataBroker, final BindingAwareBroker bindingAwareBroker) {
