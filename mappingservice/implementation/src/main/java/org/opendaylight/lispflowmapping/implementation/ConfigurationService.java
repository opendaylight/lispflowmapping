 ...
 */
public class ConfigurationService implements ManagedService, AutoCloseable {
    ...
    public ConfigurationService() {
        ...
        LOG.info("Registered configuration service!");
    }
    ...
    public void updated(Dictionary dictionary) throws ConfigurationException {
        ...
        while (keys.hasMoreElements()) {
            ...
            if (configMethods.containsKey(key)) {
                LOG.debug("Setting configuration {} = {}", keys, dictionary.get(key));
