...
public final class DSBEInputUtil {
    ...
    public static Mapping toMapping(MappingOrigin origin, Eid key, SiteId siteId, MappingData extRecord) {
    ...
    public static XtrIdMapping toXtrIdMapping(MappingData extRecord) {
        MappingRecord record = (extRecord != null) ? extRecord.getRecord() : null;
