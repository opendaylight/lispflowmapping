...
public class LispLCAFAddressSerializer extends LispAddressSerializer{
    ...
    public int getAddressSize(LispAddress lispAddress) {
        return Length.LCAF_HEADER + LispLCAFAddressSerializerFactory.getLCAFSerializer(((LispLCAFAddress)lispAddress).getType()).getLcafLength(lispAddress);
    }
    ...
    public static void serializeLCAFAddressHeader(ByteBuffer buffer, LispAddress lispAddress) {
