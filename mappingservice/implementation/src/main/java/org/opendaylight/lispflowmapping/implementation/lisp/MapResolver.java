...
import org.opendaylight.yang.gen.v1.urn.opendaylight.lfm.lisp.proto.rev150820.mapping.record.list.MappingRecordItemBuilder;
                ...
                if (nextHop != null) {
                    ...
                    recordBuilder.getLocatorRecord().add(
                            new LocatorRecordBuilder().setLocalLocator(record.isLocalLocator())
                                    ...
                                    .setMulticastPriority(record.getMulticastPriority()).setRouted(record.isRouted())
                                    .setRloc(LispAFIConvertor.toRloc(nextHop)).setLocatorId(record.getLocatorId()).build());
                }
            }
