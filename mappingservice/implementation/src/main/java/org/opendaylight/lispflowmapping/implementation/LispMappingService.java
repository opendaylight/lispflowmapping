...
public class LispMappingService implements CommandProvider, IFlowMapping {
    ...
    public String getAuthenticationKey(LispAddress address, int maskLen, String key) {
        return mapServer.getAuthenticationKey(address, maskLen, key);
    }

    public boolean removeAuthenticationKey(LispAddress address, int maskLen, String key) {
        return mapServer.removeAuthenticationKey(address, maskLen, key);
    }
