...
public class LispMappingService implements CommandProvider, IFlowMapping, IFlowMappingShell, BindingAwareProvider,
    ...
    public LispMappingService(DataBroker dataBrokerService, RpcProviderRegistry rpcRegistry, BindingAwareBroker broker) {
        LOG.info("LispMappingService Module started!");
        lfmService = this;
