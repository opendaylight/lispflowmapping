...
public interface IStorageBackend {
    ...
    /**
     * @param index points to the object we want to retrieve.
     * @return the mapping object from the back-end storage.
     */
    public EidToLocatorRecord retrieveMapping(StorageIndex index);

    /**
     * @param index points to the object we want to delete.
     */
    public void deleteMapping(StorageIndex index);
     ...
     * @param index points to the object we want to delete.
     */
    public void deleteKey(StorageIndex index);
}
