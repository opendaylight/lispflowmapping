...
public class MappingSystem implements IMappingSystem {
    ...
    public Object getMapping(Eid src, Eid dst) {
        ...
        if (ConfigIni.getInstance().getLookupPolicy().equalsIgnoreCase("northboundAndSouthbound")) {
    ...
    private Object getMappingNbFirst(Eid src, Eid dst) {
        ...
        //ConfigIni.getInstance().getLookupPolicy().equalsIgnoreCase("northboundFirst")
    ...
    private Object getMappingNbSbIntersection(Eid src, Eid dst) {
        //lookupPolicy == northboundAndSouthbound, we return intersection
