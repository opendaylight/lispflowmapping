 ...
 *
 */
@Component(service = IMappingService.class, immediate = true, property = "type=default", reference = {
    @Reference(name = "broker", service = DataBroker.class),
    @Reference(name = "rpcProviderService", service = RpcProviderService.class),
    @Reference(name = "notificationPublishService", service = NotificationPublishService.class),
    @Reference(name = "lispDAO", service = ILispDAO.class)})
@Singleton
