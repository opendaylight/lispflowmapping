...
public class MappingService implements OdlMappingserviceService, IMappingService, AutoCloseable {
    ...
    @Override
    public void addMapping(MappingOrigin origin, Eid key, SiteId siteId, ExtendedMappingRecord mapping, boolean merge) {
        ...
        if (origin.equals(MappingOrigin.Southbound)) {
            ...
            if (mapping.getRecord().getXtrId() != null) {
    ...
    public Future<RpcResult<GetMappingOutput>> getMapping(GetMappingInput input) {
        ...
        ExtendedMappingRecord reply = mappingSystem.getMapping(convertToBinaryIfNecessary(input.getEid()));
    ...
    @Override
    public ExtendedMappingRecord getMapping(Eid key) {
        return mappingSystem.getMapping(key);
    }

    @Override
    public ExtendedMappingRecord getMapping(Eid srcKey, Eid dstKey) {
    ...
    public Future<RpcResult<GetMappingWithXtrIdOutput>> getMappingWithXtrId(GetMappingWithXtrIdInput input) {
        ...
        ExtendedMappingRecord reply = mappingSystem.getMapping(null, convertToBinaryIfNecessary(input.getEid()),
                input.getXtrId());
