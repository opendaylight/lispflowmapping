...
public class InstanceIdentifierUtil {
    public static InstanceIdentifier<AuthenticationKey> createAuthenticationKeyIid(LispAddress eid) {
    ...
    public static InstanceIdentifier<Mapping> createMappingIid(LispAddress eid, MappingOrigin orig) {
    ...
    private static long getLispInstanceId(LispAddress address) {
        Address eid = address.getAddress();
        if (eid instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.lisp.address.types.rev150309.lcaf.address.address.InstanceId) {
            return ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.lisp.address.types.rev150309.lcaf.address.address.InstanceId) eid).getInstanceId().getIid().getValue();
        }
        return 0L;
    }

    private static String getURIAddressString(LispAddress address) {
        return LispAddressStringifier.getURIString(address);
    }
}
