...
public class MapServerMockitoTest {
    ...
    private static final SubscriberRLOC SUBSCRIBER_RLOC_3 = new SubscriberRLOC(RLOC_3,         // timedOut() == true
            IPV4_SOURCE_EID_3, new Date(86400000L * 2));
    ...
    private static final SubscriberRLOC SUBSCRIBER_RLOC_5 = new SubscriberRLOC(RLOC_5,         // timedOut() == true
            IPV4_SOURCE_EID_5, new Date(86400000L * 2));
    ...
    public void init() throws NoSuchFieldException, IllegalAccessException  {
        ...
        subscriberSetMock_1.add(SUBSCRIBER_RLOC);
    ...
    public void handleMapRegisterTest_MappingMergeFalse() throws NoSuchFieldException, IllegalAccessException {
        ...
        Mockito.verify(mapService).addData(MappingOrigin.Southbound, IPV4_EID, SubKeys.SUBSCRIBERS, subscriberSetMock_1);
    ...
    public void handleMapRegisterTest_withTwoMappingRecords() {
        ...
        Mockito.verify(mapService).addData(MappingOrigin.Southbound, IPV4_EID, SubKeys.SUBSCRIBERS,
                subscriberSetMock_3);
