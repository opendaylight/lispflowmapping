...
public class TimeBucketWheelUnitTest {
    ...
    private void checkOlderThanCurrentCase(TimeBucketWheel timeBucketWheel) {
        ...
        Mockito.verify(mappingSystem).handleSbMappingExpiration(IPV4_EID_2, toBeExpiredMappingData);
    }
    ...
    public void expiredMappingClearedProperlyTest() {
        ...
        Mockito.verify(mappingSystem).handleSbMappingExpiration(IPV4_EID_1,
                mappingData);
    }
