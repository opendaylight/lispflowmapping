...
public class MapResolverMockitoTest {
    ...
    public void handleMapRequest__withSubscribersToRemove() {
        ...
        // verify that itrRloc is subsribed to dst address
    ...
    public void handleMapRequest_withMultipleEids() {
        ...
        LocatorRecordBuilder locatorRecordBuilder_1 = getDefaultLocatorBuilder();
        LocatorRecordBuilder locatorRecordBuilder_2 = getDefaultLocatorBuilder();
        ...
        // mappingRecordBuilder_2.setEid(IPV6_PREFIX_EID); // override the default value
