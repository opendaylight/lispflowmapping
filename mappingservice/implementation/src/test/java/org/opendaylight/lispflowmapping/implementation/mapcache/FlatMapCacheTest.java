...
public class FlatMapCacheTest {
    ...
    public void addMappingTest() {
        ...
        verify(daoMock).put(NORMALIZED_EID, new MappingEntry<>(SubKeys.RECORD, (Object) "dummy_object"));
    }
    ...
    public void getMappingTest() {
        ...
        assertEquals((Object) "dummy_object", FLAT_MAP_CACHE.getMapping(eidMock, EID_TEST));
    }
    ...
    public void addAuthenticationKeyTest() {
        MappingAuthkey authKey = new MappingAuthkeyBuilder().setKeyString("auth_string_test").build();
