...
public class MapServerTest {
    ...
    public void handleMapRegisterTest_findNegativeSubscribers() throws NoSuchFieldException, IllegalAccessException {
        ...
        mapRegister.getMappingRecordItem().add(getDefaultMappingRecordItemBuilder(IPV4_EID_1).build());
        ...
        Mockito.when(mapService.getData(MappingOrigin.Southbound, IPV4_EID_1, SubKeys.SUBSCRIBERS)).thenReturn(null);
        ...
        Mockito.verify(subscriber2).timedOut();
    }
