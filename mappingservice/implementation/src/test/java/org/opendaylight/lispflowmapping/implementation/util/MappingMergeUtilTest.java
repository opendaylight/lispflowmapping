...
public class MappingMergeUtilTest {
    ...
    public void mappingIsExpiredTest() {
        ...
        assertTrue(MappingMergeUtil.mappingIsExpired(mappingRecordBuilder.setTimestamp(timestamp - 200001L).build()));
    ...
    public void timestampIsExpiredTest_withDate() {
        long timestamp = new Date().getTime();
        assertTrue(MappingMergeUtil.timestampIsExpired(new Date(timestamp - 200001L)));
        assertFalse(MappingMergeUtil.timestampIsExpired(new Date(timestamp)));
    }

    /**
     * Tests {@link MappingMergeUtil#computeNbSbIntersection} method, Nb mask > SB mask.
     */
    @Test
    public void computeNbSbIntersectionTest_withMaskableIpv4PrefixEIDs_() {
        ...
        assertEquals(24, (short) result.getMaskLength());
    }
    ...
    /**
     * Tests {@link MappingMergeUtil#computeNbSbIntersection} method with SourceDestKey Eid address type,
     * Nb mask < SB mask.
     */
    @Test
    @Ignore
    public void computeNbSbIntersectionTest_withMaskableSourceDestKeyEIDs() {
    ...
    public void getCommonLocatorRecords_priorityCheck() {
        ...
        final Iterator iterator = result.getLocatorRecord().iterator();
        final LocatorRecord resultLocator_1 = (LocatorRecord) iterator.next();
        final LocatorRecord resultLocator_2 = (LocatorRecord) iterator.next();
