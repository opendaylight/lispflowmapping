...
import static org.opendaylight.controller.md.sal.binding.api.DataObjectModification.*;
...
public class MappingDataListenerTest {
    ...
    public void init() {
        ...
        final InstanceIdentifier instanceIdentifierMock = Mockito.mock(InstanceIdentifier.class);
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void onDataTreeChangedTest_delete_SB() throws InterruptedException {
        final List<DataTreeModification<Mapping>> changes = Lists.newArrayList(change_del);
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void onDataTreeChangedTest_subtreeModified_SB() throws InterruptedException {
        final List<DataTreeModification<Mapping>> changes = Lists.newArrayList(change_subtreeModified);
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void onDataTreeChangedTest_write_SB() throws InterruptedException {
        final List<DataTreeModification<Mapping>> changes = Lists.newArrayList(change_write);
