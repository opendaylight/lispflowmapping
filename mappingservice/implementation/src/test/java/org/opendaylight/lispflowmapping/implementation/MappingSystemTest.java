...
public class MappingSystemTest {
    ...
    public void getMappingTest_NbFirst_withServicePathDestinationAddress_singleELPLocatorRecord() {
        ...
        final Ipv4 ipv4Result = (Ipv4) result.getLocatorRecord().get(0).getRloc().getAddress();
    ...
    public void updateMappingRegistrationTest() {
        ...
        mappingSystem.updateMappingRegistration(MappingOrigin.Northbound, EID_IPV4_1);
        Mockito.verify(pmcMock).updateMappingRegistration(EID_IPV4_1);
    }
