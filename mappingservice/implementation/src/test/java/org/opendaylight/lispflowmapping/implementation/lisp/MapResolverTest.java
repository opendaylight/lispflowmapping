...
//        allowing(lispDAO).get(v4Address);
//        will(returnValue(results.get(v4Address)));
//        allowing(lispDAO).get(v6Address);
//        will(returnValue(results.get(v6Address)));
        // allowing(lispDAO).get(weq(v4Address));
        // oneOf(lispDAO).get(weq(v4Address));
//        ret(results.get(v4Address));
