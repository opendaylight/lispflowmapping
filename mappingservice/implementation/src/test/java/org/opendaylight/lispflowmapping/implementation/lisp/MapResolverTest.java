...
public class MapResolverTest extends BaseTestCase {
    ...
    private HashMap<MappingServiceKey, Map<String, Object>> daoResults;
    ...
    public void before() throws Exception {
        ...
        daoResults = new HashMap<MappingServiceKey, Map<String, Object>>();
    }
    ...
    private Map<String, Object> prepareMapping(EidToLocatorRecord... records) {
        ...
        ValueSaverAction<MappingServiceKey> daoGetSaverAction = new ValueSaverAction<MappingServiceKey>() {
            @Override
            protected boolean validate(MappingServiceKey value) {
                return true;
            }
            @Override
        ...
        return daoResults.get(new MappingServiceKey(v4Address));
    }
