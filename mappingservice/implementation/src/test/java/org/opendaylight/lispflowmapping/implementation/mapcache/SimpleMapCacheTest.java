...
public class SimpleMapCacheTest {
    ...
    private static final String IPV4_STRING_DST =    "192.168.0.255";
    private static final String IPV4_PREFIX_STRING = "/32";
    private static final short MASK = 32;
    ...
    public void getDaoEntryBestTest_withNullEntry() {
        ...
        Mockito.verify(daoMock, Mockito.times(32)).get(Mockito.any(Eid.class));
    }
