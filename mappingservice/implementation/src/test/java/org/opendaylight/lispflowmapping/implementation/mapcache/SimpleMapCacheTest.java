...
public class SimpleMapCacheTest {
    ...
    private static final MappingAuthkey MAPPING_AUTHKEY = new MappingAuthkeyBuilder().setKeyString("pass").build();
    ...
    /**
     * Tests {@link SimpleMapCache#removeMapping} method with null VNI table.
     */
    @Test
    ...
    /**
     * Tests {@link SimpleMapCache#getAuthenticationKey} method with no VNI table.
     */
    @Test
    ...
    /**
     * Tests {@link SimpleMapCache#removeAuthenticationKey} method with no VNI table.
     */
    @Test
    ...
    public void getMappingLpmEidTest_withNullXtrId() throws Exception {
        final AbstractMap.SimpleImmutableEntry<Eid, Map<String, Object>> daoEntryMock =
                Mockito.mock(AbstractMap.SimpleImmutableEntry.class);
        final Map<String, Object> mapMock = Mockito.mock(Map.class);
        final Date expiredDate = new Date(System.currentTimeMillis() - (REGISTRATION_VALIDITY + 1L));
        ...
        PowerMockito.doReturn(daoEntryMock) // stubbing private method getDaoPairEntryBest(Eid, ILispDAO)
                ...
                .withArguments(EID_IPV4_PREFIX_DST, tableMock);
        Mockito.when(daoEntryMock.getValue()).thenReturn(mapMock);
        Mockito.when(mapMock.get(SubKeys.REGDATE)).thenReturn(expiredDate);
    ...
    /**
     * Tests {@link SimpleMapCache#getVniTable} method with Eid VNI == 100L.
     */
    @Test
    ...
    /**
     * Tests {@link SimpleMapCache#updateMappingRegistration} method with no VNI table.
     */
    @Test
    ...
    /**
     * Tests {@link SimpleMapCache#getData} method with no VNI table.
     */
    @Test
    ...
    /**
     * Tests {@link SimpleMapCache#removeData} method with no VNI table.
     */
    @Test
    ...
    /**
     * Tests {@link SimpleMapCache#addMapping} method with mappin merge false.
     */
    @Test
    ...
    public void getOrInstantiateVniTableTest_withNullVni() throws Exception {
        ...
        simpleMapCache.addMapping(EID_IPV4_PREFIX_2, mappingRecordMock, false, false); // Eid VNI == null
        Mockito.verify(daoMock).getSpecific(0L, SubKeys.VNI);
    ...
    public void getOrInstantiateVniTableTest_withNullVniAndTable() throws Exception {
        ...
        simpleMapCache.addMapping(EID_IPV4_PREFIX_2, mappingRecordMock, true, false); // Eid VNI == null
    ...
    public void getOrInstantiateVniTableTest_withNullTable() throws Exception {
        ...
        simpleMapCache.addMapping(EID_IPV4_PREFIX_1_VNI, mappingRecordMock, false, false); // Eid VNI == null
