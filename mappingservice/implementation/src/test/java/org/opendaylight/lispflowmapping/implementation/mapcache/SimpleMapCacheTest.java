...
public class SimpleMapCacheTest {
    ...
    /**
     * Tests {@link SimpleMapCache#getAllXtrIdMappings} method.
     */
    @Test
    public void getAllXtrIdMappingsTest() {
        //TODO
    }
    ...
    public void getDaoEntryBestTest_withNullEntry() {
        final Eid normalizedKey = MaskUtil.normalize(EID_IPV4);
        Mockito.when(daoMock.get(normalizedKey)).thenReturn(null);

        assertNull(simpleMapCache.getAllXtrIdMappings(EID_IPV4));
    }
