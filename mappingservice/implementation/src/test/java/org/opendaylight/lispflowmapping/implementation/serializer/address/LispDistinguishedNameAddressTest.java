...
public class LispDistinguishedNameAddressTest extends BaseTestCase {
    ...
    @Test
    public void deserialize__ShorterWithZeroBeforeEnd() throws Exception {
        LispAddressSerializer.getInstance().deserialize(hexToByteBuffer("00 11 64 61 76 00 69 64"));
    }
