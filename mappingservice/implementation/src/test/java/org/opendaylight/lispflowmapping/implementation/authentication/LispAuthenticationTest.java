...
public class LispAuthenticationTest extends BaseTestCase{
    ...
    public void validate_WrongAuthentication() throws Exception {
            ...
            assertFalse(LispAuthentication.getInstance().validate(mapRegister));
    }
    ...
    public void validate__SHA1() throws Exception {
            ...
            assertTrue(LispAuthentication.getInstance().validate(mapRegister));
    }
    ...
    public void authenticate__MapNotifySHA1() throws Exception {
            ...
            byte[] wantedAuthenticationData = new byte[] { (byte) 0x66, (byte) 0x69,
                            ...
                            (byte) 0xaa, (byte) 0x2c };
            System.out.println(HexUtils.toHexString(LispAuthentication.getInstance().getAuthenticationData(mapNotify)));
            ArrayAssert.assertEquals(wantedAuthenticationData, LispAuthentication.getInstance().getAuthenticationData(mapNotify));
    ...
    public void authenticate__MapNotifyNoAuthenticationData() throws Exception {
            ...
            ArrayAssert.assertEquals(new byte[0], LispAuthentication.getInstance().getAuthenticationData(mapNotify));
