...
public class LispAuthenticationTest extends BaseTestCase {
    ...
    public void authenticate__MapNotifySHA1() throws Exception {
        ...
        System.out.println(HexUtils.toHexString(LispAuthenticationUtil.getAuthenticationData(mapNotify, "password")));
        ArrayAssert.assertEquals(wantedAuthenticationData, LispAuthenticationUtil.getAuthenticationData(mapNotify, "password"));
    ...
    public void authenticate__MapNotifyNoAuthenticationData() throws Exception {
        ...
        ArrayAssert.assertEquals(new byte[0], LispAuthenticationUtil.getAuthenticationData(mapNotify, "password"));
